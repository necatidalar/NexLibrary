...
partial class FrmBookDetail
{
    ...
    private void InitializeComponent()
    {
        ...
        lblTitle.Size = new Size(122, 28);
        lblTitle.TabIndex = 0;
        lblTitle.Text = "Kitap Detayı";
